const calculeTotalSpentByCategory = require('../expenditure-analysis');

describe('calculeTotalSpentByCategory', () => {
    test('returns the correct total spent for a single transaction', () => {
        ...
        const result = calculeTotalSpentByCategory(transactions);
